...
import { NotificationComponent } from '../../admin/Book/notification/notification.component';

@Component({
  selector: 'app-notify-all',
  standalone: false,
  templateUrl: './notify-all.component.html',
  styleUrl: './notify-all.component.scss'
})
export class NotifyAllComponent {
